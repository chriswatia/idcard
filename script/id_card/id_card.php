...
foreach ($data as $key => $info) {
  ...
  $reg_no=$student_info1['reg_no'];
  $department=$student_info1['department'];
  $dob=$student_info1['birth_day'];
  $year_of_study =$student_info1['year_of_study'];

  $school=$student_info1['school'];
  ...
  <div class="id_box_body">
    ...
    <div style="margin-top: 10px;"></div>
      ...
      <div class="name_field">
      		<span class="id_field">Current Date: : </span> <span class="inf"><?php echo date("Y/m/d"); ?></span>
      	</div>     
      	<div class="name_field">
	      ...
	      <div class="name_field">
	      	<span class="id_field">Reg. No : </span> <span class="inf"><?php echo "$reg_no"; ?></span>
	      </div> 

        <div class="name_field">    
	      	<span class="id_field">School :</span>
	      	<span class="inf"><?php echo "$school"; ?></span>
	      </div>
	      <div class="name_field">    
	      	<span class="id_field">Department :</span>
	      	<span class="inf"><?php echo "$department"; ?></span>
	      </div> 
	      <div class="name_field">    
	      <span class="id_field">Validity :</span> <span class="inf"><?php echo "$validity"; ?></span>
	      </div>
        
	      <div class="name_field">    
	      <span class="id_field">Year of study :</span> <span class="inf"><?php echo "$year_of_study"; ?></span>
	      </div>
        <div class="name_field">    
	      <span class="id_field">Date of birth :</span> <span class="inf"><?php echo "$dob"; ?></span>
	      </div>
